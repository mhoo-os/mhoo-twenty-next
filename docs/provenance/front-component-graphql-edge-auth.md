...
Validation:15 focused tests and renderer strict typecheck pass. Browser
same-origin/other-origin cookie behavior remains to be exercised with this
exact follow-up before release. No live image, Access policy or stored record
change is part of this source increment.
