...
export interface MhooPlatformInvitationDTO {
    email: Scalars['String']
    expiresAt: Scalars['DateTime']
    __typename: 'MhooPlatformInvitationDTO'
}
...
export interface Mutation {
    ...
    sendMhooPlatformInvitation: MhooPlatformInvitationDTO
...
export interface MhooPlatformInvitationDTOGenqlSelection{
    email?: boolean | number
    expiresAt?: boolean | number
    __typename?: boolean | number
    __scalar?: boolean | number
...
export interface MutationGenqlSelection{
    ...
    sendMhooPlatformInvitation?: (MhooPlatformInvitationDTOGenqlSelection & { __args: {email: Scalars['String']} })
    getAuthorizationUrlForSSO?: (GetAuthorizationUrlForSSOGenqlSelection & { __args: {input: GetAuthorizationUrlForSSOInput} })
    getLoginTokenFromCredentials?: (LoginTokenGenqlSelection & { __args: {email: Scalars['String'], password: Scalars['String'], captchaToken?: (Scalars['String'] | null), locale?: (Scalars['String'] | null), verifyEmailRedirectPath?: (Scalars['String'] | null), mhooInvitationToken?: (Scalars['String'] | null), origin: Scalars['String']} })
    signIn?: (AvailableWorkspacesAndAccessTokensGenqlSelection & { __args: {email: Scalars['String'], password: Scalars['String'], captchaToken?: (Scalars['String'] | null), locale?: (Scalars['String'] | null), verifyEmailRedirectPath?: (Scalars['String'] | null), mhooInvitationToken?: (Scalars['String'] | null)} })
    ...
    signUp?: (AvailableWorkspacesAndAccessTokensGenqlSelection & { __args: {email: Scalars['String'], password: Scalars['String'], captchaToken?: (Scalars['String'] | null), locale?: (Scalars['String'] | null), verifyEmailRedirectPath?: (Scalars['String'] | null), mhooInvitationToken?: (Scalars['String'] | null)} })
...
export interface LogicFunctionLogsInput {applicationId?: (Scalars['UUID'] | null),applicationUniversalIdentifier?: (Scalars['UUID'] | null),name?: (Scalars['String'] | null),id?: (Scalars['UUID'] | null),universalIdentifier?: (Scalars['UUID'] | null)}
    ...
    const MhooPlatformInvitationDTO_possibleTypes: string[] = ['MhooPlatformInvitationDTO']
    export const isMhooPlatformInvitationDTO = (obj?: { __typename?: any } | null): obj is MhooPlatformInvitationDTO => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isMhooPlatformInvitationDTO"')
      return MhooPlatformInvitationDTO_possibleTypes.includes(obj.__typename)
    }
