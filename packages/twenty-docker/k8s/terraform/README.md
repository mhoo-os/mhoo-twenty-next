<!-- BEGIN_TF_DOCS -->
# Mhoo distribution Terraform Docs (built on Twenty)
...
|------|-------------|------|---------|:--------:|
| <a name="input_twentycrm_app_hostname"></a> [twentycrm\_app\_hostname](#input\_twentycrm\_app\_hostname) | The protocol, DNS fully qualified hostname, and port used to access Mhoo in your environment. Ex: https://crm.example.com:443 | `string` | n/a | yes |
| <a name="input_twentycrm_pgdb_admin_password"></a> [twentycrm\_pgdb\_admin\_password](#input\_twentycrm\_pgdb\_admin\_password) | Database password for the Mhoo distribution's PostgreSQL administrator. | `string` | n/a | yes |
...
| <a name="input_twentycrm_db_image"></a> [twentycrm\_db\_image](#input\_twentycrm\_db\_image) | Database image for the Mhoo distribution. This defaults to latest. | `string` | `"twentycrm/twenty-postgres-spilo:latest"` | no |
...
| <a name="input_twentycrm_db_replicas"></a> [twentycrm\_db\_replicas](#input\_twentycrm\_db\_replicas) | Number of replicas for the Mhoo database deployment. This defaults to 1. | `number` | `1` | no |
| <a name="input_twentycrm_docker_data_mount_path"></a> [twentycrm\_docker\_data\_mount\_path](#input\_twentycrm\_docker\_data\_mount\_path) | Docker data mount path for Mhoo server application data. Defaults to '/app/docker-data'. | `string` | `"/app/docker-data"` | no |
...
| <a name="input_twentycrm_namespace"></a> [twentycrm\_namespace](#input\_twentycrm\_namespace) | Namespace for all Mhoo resources; the default technical namespace remains twentycrm. | `string` | `"twentycrm"` | no |
| <a name="input_twentycrm_product_brand_deployment_origin"></a> [twentycrm\_product\_brand\_deployment\_origin](#input\_twentycrm\_product\_brand\_deployment\_origin) | HTTP(S) origin used for relative product links. If empty, the app hostname is used; do not include a path, query, or fragment. | `string` | `""` | no |
| <a name="input_twentycrm_product_brand_preset"></a> [twentycrm\_product\_brand\_preset](#input\_twentycrm\_product\_brand\_preset) | Product presentation preset for the Mhoo distribution. Use twenty only for an explicit upstream-compatibility fixture. | `string` | `"mhoo"` | no |
| <a name="input_twentycrm_redis_image"></a> [twentycrm\_redis\_image](#input\_twentycrm\_redis\_image) | Redis image for the Mhoo deployment. This defaults to latest. | `string` | `"redis/redis-stack-server:latest"` | no |
| <a name="input_twentycrm_redis_replicas"></a> [twentycrm\_redis\_replicas](#input\_twentycrm\_redis\_replicas) | Number of replicas for the Mhoo Redis deployment. This defaults to 1. | `number` | `1` | no |
| <a name="input_twentycrm_server_data_mount_path"></a> [twentycrm\_server\_data\_mount\_path](#input\_twentycrm\_server\_data\_mount\_path) | Server application data mount path for Mhoo. Defaults to '/app/packages/twenty-server/.local-storage'. | `string` | `"/app/packages/twenty-server/.local-storage"` | no |
| <a name="input_twentycrm_server_image"></a> [twentycrm\_server\_image](#input\_twentycrm\_server\_image) | Server image for the Mhoo distribution. This defaults to latest and is also used for the worker image. | `string` | `"twentycrm/twenty:latest"` | no |
...
| <a name="input_twentycrm_server_replicas"></a> [twentycrm\_server\_replicas](#input\_twentycrm\_server\_replicas) | Number of replicas for the Mhoo server deployment. This defaults to 1. | `number` | `1` | no |
| <a name="input_twentycrm_worker_replicas"></a> [twentycrm\_worker\_replicas](#input\_twentycrm\_worker\_replicas) | Number of replicas for the Mhoo worker deployment. This defaults to 1. | `number` | `1` | no |
<!-- END_TF_DOCS -->
