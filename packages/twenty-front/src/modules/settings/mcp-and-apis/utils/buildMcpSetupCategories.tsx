...
import { TWENTY_BRAND, type ProductBrand } from 'twenty-shared/branding';
...
type BuildMcpSetupCategoriesParams = {
  ...
  mcpServerUrl: string;
  brand?: Pick<ProductBrand, 'preset' | 'productName'>;
};
...
export const buildMcpSetupCategories = ({
  ...
  const chatGptDescription =
    brand.preset === 'mhoo'
      ? t`Open the upstream Twenty ChatGPT integration for your workspace.`
      : t`Open Twenty's official ChatGPT integration for your workspace.`;
  const chatGptBadge =
    brand.preset === 'mhoo' ? t`Upstream app` : t`Official app`;
  ...
  return [
    {
      ...
      cards: [
        ...
        },
        {
          title: t`Claude`,
          badge: t`Preset link`,
          description: t`Open Claude with the ${productName} connector name and MCP URL prefilled.`,
          ctaLabel: t`Install`,
          disabledTooltip: t`Claude install links require an HTTPS MCP URL.`,
          href: isHttpsInstallLinkEnabled
            ? buildClaudeInstallLink(mcpServerUrl, productName)
            : undefined,
      ...
      cards: [
        {
          ...
          description: t`Open Cursor's MCP installer with the ${productName} remote server config.`,
          ctaLabel: t`Install`,
        ...
        },
        {
          title: t`Goose`,
          badge: t`Install link`,
          description: t`Add ${productName} as a Streamable HTTP extension in Goose.`,
          ctaLabel: t`Install`,
          href: buildGooseInstallLink(mcpServerUrl, productName),
          logo: <McpClientLogo src={GooseLogo} invertInDarkMode />,
        },
        {
          title: t`Replit Agent`,
          badge: t`Install link`,
          description: t`Open Replit with the ${productName} remote server config.`,
          ctaLabel: t`Install`,
          disabledTooltip: t`Replit install links require an HTTPS MCP URL.`,
          href: isHttpsInstallLinkEnabled
            ? buildReplitInstallLink(mcpServerUrl, productName)
            : undefined,
          isDisabled: !isHttpsInstallLinkEnabled,
        ...
        },
        {
          title: t`LM Studio`,
          badge: t`Install link`,
          description: t`Add the ${productName} remote server with LM Studio's install link.`,
          ctaLabel: t`Install`,
        ...
        },
        {
          title: t`Cline`,
          badge: t`Manual`,
          description: t`Configure the ${productName} MCP server manually in Cline.`,
          ctaLabel: t`Docs`,
        ...
        },
        {
          title: t`Zed`,
          badge: t`Manual`,
          description: t`Add the ${productName} MCP server as a remote context server in Zed.`,
          ctaLabel: t`Docs`,
        ...
        },
        {
          ...
          badge: t`Manual`,
          description: t`Configure the ${productName} MCP server manually in Cascade.`,
          ctaLabel: t`Docs`,
        ...
        },
        {
          title: t`Raycast`,
          badge: t`Settings`,
          description: t`Add the ${productName} MCP server from Raycast's MCP commands or settings.`,
          ctaLabel: t`Docs`,
        ...
        },
        {
          title: t`Gemini CLI`,
          badge: t`CLI config`,
          description: t`Add the ${productName} MCP server in Gemini CLI settings.`,
          ctaLabel: t`Docs`,
        ...
        },
        {
          title: t`LibreChat`,
          badge: t`YAML config`,
          description: t`Add the ${productName} MCP server to your LibreChat configuration file.`,
          ctaLabel: t`Docs`,
        ...
        },
        {
          ...
          badge: t`Settings`,
          description: t`Add the ${productName} MCP server from Augment Code settings.`,
          ctaLabel: t`Docs`,
