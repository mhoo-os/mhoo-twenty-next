...
export default defineApplicationRole({
  ...
  description:
    'Native connection permission ceiling; caller permissions also apply. Allows an assigned agent to invoke the bounded merchant identity read. No provider write or public trigger.',
