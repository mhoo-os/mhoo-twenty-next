...
export const Workspace = styled.section({
  ...
  '& *': { boxSizing: 'border-box' },
  '& .fw-main > .fw-top button, & .fw-select, & .fw-date-input': { font: 'inherit' },
  ...
  '& .fw-month-choice:hover, & .fw-month-choice[aria-pressed="true"]': {
    color: 'var(--fw-accent)',
    background: 'var(--fw-soft)',
  },
  '& .fw-timeline-scroll': {
  ...
  '--fw-text': '#191a35', '--fw-muted': '#73768e', '--fw-line': '#ececf2',
  margin: '20px auto', borderColor: '#eeeef2',
  ...
  '& .fw-title': {fontWeight: 500, fontSize: '25px'},
  ...
  '& .fw-window-tools': {justifyContent: 'flex-end', margin: 0},
  ...
  '& .fw-date-fields': {display: 'grid', gridTemplateColumns: '1fr 1fr'},
  '& .fw-date-field': {display: 'grid', fontSize: '12px'},
  '& .fw-date-fields .fw-date-input': {width: '100%', minWidth: 0, fontSize: '12px'},
  '& .fw-timeline-scroll': {padding: '6px 4px 18px', borderBottom: '1px solid var(--fw-line)'},
  '& .fw-timeline-canvas': {position: 'relative', paddingTop: '34px'},
  '& .fw-year-labels': {position: 'absolute', top: '5px', left: 0, right: 0, margin: 0},
  '& .fw-year-labels span': {transform: 'none'},
  '& .fw-brush': {height: '36px', margin: '12px 0 0', border: 0, borderBottom: '1px solid var(--fw-line)', borderRadius: 0, background: 'transparent', touchAction: 'pan-x'},
  '& .fw-month-choice': {position: 'absolute', top: 0, bottom: 0, minWidth: 0, padding: 0, background: 'transparent', borderRadius: 0, fontSize: '11px'},
  '& .fw-month-choice[aria-pressed="true"]': {background: 'transparent'},
  '& .fw-window-selection': {opacity: 1, background: 'color-mix(in srgb, var(--fw-accent) 6%, transparent)', borderRadius: '2px', cursor: 'default'},
  '& .fw-range-caption': {position: 'absolute', top: '-23px', left: '2px', padding: '3px 6px', color: 'white', background: 'var(--fw-accent)', fontSize: '10px', whiteSpace: 'nowrap', borderRadius: '2px'},
  '& .fw-native-range': {position: 'absolute', left: '-4px', top: '8px', width: 'calc(100% + 8px)', height: '20px', margin: 0, padding: 0, appearance: 'none', background: 'transparent', pointerEvents: 'none', zIndex: 3},
  '& .fw-native-range::-webkit-slider-runnable-track': {height: '20px', background: 'transparent'},
  '& .fw-native-range::-webkit-slider-thumb': {appearance: 'none', width: '8px', height: '20px', border: '1px solid var(--fw-accent)', borderRadius: '2px', background: 'var(--fw-surface)', pointerEvents: 'auto', cursor: 'ew-resize'},
  '& .fw-native-range::-moz-range-thumb': {width: '8px', height: '20px', border: '1px solid var(--fw-accent)', borderRadius: '2px', background: 'var(--fw-surface)', pointerEvents: 'auto', cursor: 'ew-resize'},
  '& .fw-native-range:focus-visible::-webkit-slider-thumb': {outline: '2px solid var(--fw-accent)', outlineOffset: '2px'},
