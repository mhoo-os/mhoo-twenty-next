...
export const Workspace = styled.section({
  ...
  '& .fw-source-grid': { display: 'grid', gridTemplateColumns: 'repeat(2, minmax(0, 1fr))', columnGap: '30px', borderTop: '1px solid var(--fw-line)' },
  '& .fw-source-card': { display: 'grid', gridTemplateRows: '1fr auto', gap: '22px', minWidth: 0, padding: '24px 0 22px', borderBottom: '1px solid var(--fw-line)' },
  '& .fw-source-copy': { minWidth: 0 },
  '& .fw-source-heading': { display: 'flex', alignItems: 'baseline', justifyContent: 'space-between', gap: '12px', marginBottom: '8px' },
  '& .fw-source-heading h2': { margin: 0, color: 'var(--fw-text)', fontSize: financeInsightsTokens.sectionTitleSize, fontWeight: 500, letterSpacing: '-.15px' },
  '& .fw-source-type': { color: 'var(--fw-muted)', fontSize: '9px', fontWeight: 500, letterSpacing: '.04em', lineHeight: 1.4, textAlign: 'right' },
  '& .fw-source-copy > p': { maxWidth: '42ch', margin: 0, color: 'var(--fw-muted)', fontSize: financeInsightsTokens.controlSize, lineHeight: 1.6 },
  '& .fw-source-action': { display: 'flex', alignItems: 'flex-end', justifyContent: 'space-between', gap: '16px' },
  '& .fw-source-action .fw-local': { maxWidth: '28ch', margin: 0, textAlign: 'right' },
  ...
  '@media (max-width: 580px)': {
    ...
    '& .fw-source-grid': { gridTemplateColumns: '1fr' },
    '& .fw-source-card': { gap: '16px', padding: '20px 0' },
    '& .fw-source-heading': { alignItems: 'flex-start', flexDirection: 'column', gap: '4px' },
    '& .fw-source-type': { textAlign: 'left' },
    '& .fw-source-action': { alignItems: 'flex-start', flexDirection: 'column', gap: '10px' },
    '& .fw-source-action .fw-local': { maxWidth: 'none', textAlign: 'left' },
