...
See the approved [Mhoo DPA Availability Notice](/legal/dpa).
</Accordion>
<Accordion title="Where can we find Mhoo's current privacy terms?">
See the approved [Mhoo Privacy Policy](/legal/privacy).
</Accordion>
...
If you have more questions, please check the approved [Mhoo Master Terms of Service](/legal/terms), [Mhoo Privacy Policy](/legal/privacy), [Mhoo Acceptable Use Policy](/legal/acceptable-use), and [Mhoo Open Source & Upstream License Notice](/legal/open-source). For DPA availability, see the [Mhoo DPA Availability Notice](/legal/dpa).
