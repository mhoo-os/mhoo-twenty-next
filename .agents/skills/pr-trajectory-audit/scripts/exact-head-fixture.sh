...
head="${2:-HEAD}"
allowed='^(\.twenty-source|CLAUDE\.md|AGENTS\.md|docs/provenance/clean-foundation-overlay\.md|scripts/provenance/verify-source\.sh|\.agents/skills/pr-trajectory-audit/|\.github/workflows/(trajectory-eval|clean-foundation-ci)\.yml|deploy/twenty-next/)'
