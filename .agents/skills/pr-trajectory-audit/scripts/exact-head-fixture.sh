...
head="${2:-HEAD}"
allowed='^(\.twenty-source|CLAUDE\.md|AGENTS\.md|docs/provenance/clean-foundation-overlay\.md|scripts/provenance/verify-source\.sh|scripts/release/mho183-[^/]+\.(sh|mjs)|\.agents/trajectory-review\.json|\.agents/skills/pr-trajectory-audit/|\.github/workflows/(trajectory-eval|clean-foundation-ci|clean-foundation-image)\.yml|deploy/twenty-next/)'
